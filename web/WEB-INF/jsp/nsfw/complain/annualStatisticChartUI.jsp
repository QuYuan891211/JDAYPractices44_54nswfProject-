...
<script type="text/javascript" src="${basePath}js/fusionChart/fusioncharts.charts.js"></script>
<script type="text/javascript" src="${basePath}js/fusionChart/themes/fusioncharts.theme.fint.js"></script>
