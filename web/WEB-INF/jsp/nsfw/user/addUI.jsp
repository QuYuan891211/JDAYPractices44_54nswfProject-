...
<form id="form" name="form" action="${basePath}nswf/user_add.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        <tr>
            ...
            <td><s:select name="user.dept" list="#{'DepartmentA':'DepartmentA','DepartmentB':'DepartmentB'}"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><s:textfield id="birthday" name="user.birthday" readonly="true" onfocus="WdatePicker({skin:'whyGreen',el:'birthday',dateFmt:'yyyy-MM-dd'})"/></td>
        </tr>
		<tr>
