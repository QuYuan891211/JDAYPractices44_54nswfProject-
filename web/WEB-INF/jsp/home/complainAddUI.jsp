...
<head>
    ...
    <title>我要投诉</title>
    <script type="text/javascript" charset="utf-8" src="${basePath }js/UEditor/utf8_jsp/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="${basePath }js/UEditor/utf8_jsp/ueditor.all.min.js"> </script>
    <script type="text/javascript" charset="utf-8" src="${basePath }js/UEditor/utf8_jsp/lang/zh-cn/zh-cn.js"></script>

    <script>
        window.UEDITOR_HOME_URL = "${basePath }js/UEditor/utf8_jsp/";
...
<form id="form" name="form" action="" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:select id="toCompDept" name="comp.toCompDept" list="#{'':'请选择','DepartmentA':'DepartmentA','DepartmentB':'DepartmentB' }" onchange="doSelectDept()"/></td>
        </tr>
        <tr>
